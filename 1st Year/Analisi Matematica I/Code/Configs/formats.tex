...
\newcommand*{\blankpage}{
{\newpage \vspace*{5cm}\thispagestyle{empty}\centering \bfseries  \textit{Otterrai il voto di questo esame a distanza di cinque mesi dal suo svolgimento... se sei fortunato.} \par}
\vspace{\fill}}
