...
\begin{itemize}
    ...
    La funzione diagonale o identità, denotata con $id_X(x) = x$ per ogni $x \in X$, restituisce lo stesso valore che le è stato assegnato.\par
    ...
    \end{center}
    INSERIRE IMMAGINE.
    \item \textbf{Funzione quadratica} - 
    \item \textbf{Funzione di Dirichlet} - 
\end{itemize}
