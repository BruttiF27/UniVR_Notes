...
Una FSMD è il connubio fra le due macrocomponenti viste prima e sta per \textbf{Macchina a stati finiti con unità di elaborazione}. Si compone di due parti; quella di controllo e quella di elaborazione, le quali comunicano mediante segnali di stato e controllo. Si tratta di una macchina sincrona.
