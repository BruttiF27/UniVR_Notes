...
\noindent Sia ora $X_1, ..., X_n$ un campione casuale preso da una popolazione di densità $f(x,\theta)$, che dipende dal parametro $\theta$. Se interpretiamo \[f(x_1, ..., x_n; \theta)\]
\noindent come la verosimiglianza che si realizzi la n-upla $x_1, ..., x_n$ di dati quando $\theta$ è il vero valore del parametro, possiamo prendere come sua stima il \textit{valore che rende massima la funzione}, chiamato \textbf{stimatore di massima verosimiglianza}, il quale è consigliato vedere come logaritmo, in quanto ha uno stesso massimo e facilita i calcoli.
\begin{eg}
	\textbf{Calcolo dello stimatore di massima verosimiglianza}\par
	% TODO
	\noindent INSERISCI ESEMPIO PER STIMATORE MAX VEROSIMIGLIANZA PER BERNOULLI E POPOLAZIONE NORMALE.
\end{eg}
