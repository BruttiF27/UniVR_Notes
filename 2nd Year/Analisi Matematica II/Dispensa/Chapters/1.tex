...
\begin{center}
	$y' = a(t)b(y) \equiv a(t) = \dfrac{y'}{b(y)}$
\end{center}
con $a$ funzione continua su un intervallo $I \subset \mathbb{R}$ e $b$ funzione continua su un intervallo $J \subset \mathbb{R}$.
Dalle conoscenze di logica, noterai che questa scrittura è possibile in quanto la variabile $t$ è libera in $b$, quindi se la sposti non ti causa alcun problema.
