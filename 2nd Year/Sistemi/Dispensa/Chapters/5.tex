...
Essendo i grafici in una scala logaritmica sull'asse delle $x$, avremo intervalli dati dalle potenze di $10$, chiamati \textbf{decadi}; quindi il minimo è dato da $-\infty$, il massimo è $+\infty$ e non si tocca mai lo zero. Gli intervalli di decadi sono graficamente definiti dallo spazio di $10$ quadrati del grafico.\newline

% TODO Inserire esempio di grafico logaritmico

\noindent Stiamo ragionando in termini di risposta in frequenza, quindi partiamo da un sistema che divide l'input in due parti per andare in due blocchi diversi. Poi somma questi due output per ritornare l'uscita. Supponiamo che:
\begin{itemize}
...
\end{cases}\]
\noindent Tuttavia, usando la funzione segno, otteniamo una forma di Arg più compatta, definita come \[sng(\alpha) = \begin{cases}
	\alpha > 0 \implies 1\\
	0
