...
Come già menzionato, i diagrammi di Bode sono due, uno per l'ampiezza e l'altro per la fase. Questi possono rappresentare ogni singolo fattore nella relativa forma di Bode che si suppone ottenuta dalla funzione di trasferimento. Ciò significa che esistono diagrammi per rappresentare:
\begin{itemize}
...
\noindent\textbf{Termine costante} $K_b = H(j\omega)$\par
