...
\begin{itemize}
	\item \textbf{Periodicità}: Esiste un certo periodo $t_0$ che se sommato a $t$ ritorna lo stesso risultato. $t_0$ è il numero più piccolo per il quale vale questa proprietà.
...
\noindent \textbf{Segnali esponenziali}: $x(t) = Ce^{at}; x[n] = Ce^{bn}$
% Inserisci il significato delle componenti della formula
% Inserisci le proprietà del tipo di segnale
% Inserisci il disegno del segnale

% TODO CONTINUA DA LEZIONE 4
% Gli appunti ci sono, devi solo riorganizzarli.
