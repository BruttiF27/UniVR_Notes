...
\noindent \textbf{Esercizio 4}: Sia un'applicazione A che desidera trasferire $104400B$ ad una seconda applicazione B. Si suppone che la connessione sia
già instaurata e presenti i seguenti parametri: \begin{itemize}
	\item Maximum Segment Size: $1200B$
	\item Receive Window: $9600B$. A partire da $t>4s$, B annuncia una nuova dimensione di $14400B$ e dopo $t>9s$ ne annuncia un'altra di $7200B$.
	\item Slow Start Threshold: $\text{RCVWND}_i$.
	\item Round-trip time: $1s$, rimane costante per tutta la trasmissione.
	\item Retransmission time-out: $2RTT$, raddoppia in caso di perdite sequenziali.
\end{itemize}
\noindent È inoltre presente un down di rete durante l'intervallo di tempo $(11.5, 12.5)$. Valutare l'evoluzione temporale della congestion window fino
al termine della trasmissione.\par
L'aggiornamento della dimensione della Receive window è comunicato dalla destinazione; di conseguenza verrà modificata
solo dopo aver ricevuto i messaggi di acknoledgement, quindi al termine dell'RTT. \begin{itemize}
	\item $\text{Segmenti: } 104000/1200 = 87$
	\item $\text{RCVWNDS: } \left<9600/1200=8, 14400/1200=12, 7200/1200=6\right>$
	\item $\text{SSTHR} = \text{RCVWND}_i$
\end{itemize}
\noindent Trasmissione: \begin{itemize}
	\item $1+2+4+8+8+9+10+11+12+12+6+0 = 83$. Down di rete, gli ack non sono stati ricevuti e parte quindi l'RTO.
	\item $83+1+2+(3-2) = 87$.
\end{itemize}
\noindent Dimensione finale della CWND: $3+1/3$, tempo di trasmissione totale: $t = 16s$.
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{Images/tcp_ex4.png}
	\caption{Evoluzione trasmissione esercizio 4}
\end{figure}
