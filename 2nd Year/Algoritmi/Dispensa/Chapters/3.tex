...
le condizioni in cima e in fondo alla lista. Si tratta dell'implementazione di oggetti della lista che rappresentano $NIL$, ma che allo stesso tempo
hanno anche tutti gli attributi dei nodi veri.
