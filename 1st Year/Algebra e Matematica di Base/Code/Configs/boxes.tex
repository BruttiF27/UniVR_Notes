...
\declaretheorem[numberwithin=chapter,style=thmbox, name=Definizione]{definition}
\declaretheorem[sibling=definition,style=thmbox, numbered=no, name=Esempio]{eg}
\declaretheorem[sibling=definition,style=thmbox, name=Proposizione]{prop}
...
\declaretheorem[sibling=definition,style=thmbox, name=Corollario]{corollary}
