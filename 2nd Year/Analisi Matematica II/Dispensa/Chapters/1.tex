...
\end{center}
Questa equazione ottenuta si dice \textbf{equazione caratteristica} ed è risolvibile come una normalissima equazione di secondo grado, con la formula del discriminante $\Delta = a^2 - 4b$. In tal merito, ci è possibile distinguere tre casi:
\begin{itemize}
	\item $\Delta > 0$; L'equazione caratteristica avrà due radici reali e distinte $r_1,r_2$, quindi le funzioni $z_1(t) = e^{r_1t}$ e $z_2(t) = e^{r_2t}$ saranno due soluzioni distinte e indipendenti dell'equazione omogenea. St tratta del caso più semplice e l'integrale si scrive come:
	\begin{center}
...
metodo di sovrapposizione e metodo di somiglianza